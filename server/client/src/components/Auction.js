...
export class Auction extends Component {
    ...
    postItem(e) {
        ...
        if (this.state.category === '' || this.state.item_name === '' || this.state.item_price === '' ||
            ...
            data.append('item_image', this.state.file)
            data.append('item_video', this.state.item_video)
                        ...
                        <form action="/products" method="POST" encType = "multipart/form-data" >
                            <div className="item-details">
                                <div className="item-description">
                                    ...
                                    <input type="file" name="file" id="img" accept="image/*" className="item-input" onChange={this.handleChange} /><br />
